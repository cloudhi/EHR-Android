...
import com.philit.ehr.superclock.AlarmClock;
...
public class MedicineFragment extends Fragment implements OnItemClickListener{
    ...
    public MedicineFragment(int type){
    	this.type = type;
    }
