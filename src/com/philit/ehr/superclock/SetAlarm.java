...
public class SetAlarm extends PreferenceActivity
    ...
    private EditTextPreference type;
    ...
    private CheckBoxPreference mAlarmPref;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mAlarmPref = (CheckBoxPreference) findPreference("alarm");
        ...
        back.setOnClickListener(new BackBtnClickListener(this));*/
        ...
        //获取type
        type = new EditTextPreference(this);
        type.setText(getIntent().getIntExtra(Alarms.ALARM_TYPE, 1)+"");
    }
    ...
    private void updatePrefs(Alarm alarm) {
        ...
        if (alarm.silent) {//如果是静音
        	mAlarmPref.setChecked(false);
        }else {
        	mAlarmPref.setChecked(true);
		}
    ...
    private long saveAlarm() {
        ...
        if (!mAlarmPref.isChecked()) {
        	alarm.silent=true;
        	alarm.alert =Uri.parse("silent") ;
		}else {
			alarm.silent=false;
			alarm.alert =Uri.parse(Notification.DEFAULT_SOUND+"");
		}
        ...
        alarm.type=Integer.parseInt(type.getText());
	...
	public void setType(EditTextPreference type) {
		this.type = type;
	}

	public EditTextPreference getType() {
		return type;
	}
