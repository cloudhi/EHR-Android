...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.philit.ehr", "alarm", ALARMS);
        sURLMatcher.addURI("com.philit.ehr", "alarm/#", ALARMS_ID);
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    "(hour, minutes, daysofweek, alarmtime, enabled, vibrate, message, alert,times,type) " +
                    "VALUES ";
            db.execSQL(insertMe + "(12, 00, 31, 0, 1, 1, '', '',0,1);");
            db.execSQL(insertMe + "(22, 00, 96, 0, 1, 1, '', '',0,2);");
        }
