...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.philit.ehr.superclock.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.philit.ehr.superclock.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.philit.ehr.superclock.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.philit.ehr.superclock.ALARM_DISMISS";
     ...
     */
    public static Cursor getAlarmsCursor(ContentResolver contentResolver, String selection, String[] selectionArgs ) {
        return contentResolver.query(
                Alarm.Columns.CONTENT_URI, Alarm.Columns.ALARM_QUERY_COLUMNS,
                selection, selectionArgs, Alarm.Columns.DEFAULT_SORT_ORDER);
    }
...
//    }
    ...
    private static void setStatusBarIcon(Context context, boolean enabled) {
    	...
    	Intent viewAlarm = new Intent(context, Main.class);
